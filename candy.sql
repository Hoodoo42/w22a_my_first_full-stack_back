...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_candy`(name_input varchar(20), img_url varchar(500), description_input varchar(250))
    MODIFIES SQL DATA
BEGIN
...
-- Dump completed on 2022-10-11 21:02:10
